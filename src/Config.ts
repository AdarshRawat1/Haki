...
class C {
    public static getConfiguration() {
        return workspace.getConfiguration("haki.c");
    }
...
class Cpp {
    public static getConfiguration() {
        return workspace.getConfiguration("haki.cpp");
    }
...
class File {
    public static getConfiguration() {
        return workspace.getConfiguration("haki.file");
    }
...
class Generic {
    public static getConfiguration() {
        return workspace.getConfiguration("haki.generic");
    }
